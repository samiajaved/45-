//Q31: Checking Usernames: Do the following to create a program that simulates how 
...
let currentUserName = ['Alen', 'Mike', 'Herry', 'Sana', 'John'];

let newUsers = ['john', 'Mike', 'Amaan', 'Eric', 'Ehan']

newUsers.forEach(newUsers => {
    if(currentUserName.some(currentUserName=>currentUserName.toLowerCase()===newUsers.toLowerCase())){
